...
if L then
    ...
    L["warbandCurrencyTotal"] = "Warband Total: %s%s"
    ...
    L["optionsTooltipEnhancementHeader"] = "Enhance Currency Tooltips"
    L["optionsToggleDescriptionEnhanceCurrencyTooltips"] = "Enhance Currency Tooltips"
    L["optionsToggleEnhanceCurrencyTooltipsTooltip"] = "Adds the tracked warband total on relevant currency tooltips"
