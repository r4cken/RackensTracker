...
if L then
    ...
    L["noTrackingAvailableDescription1"] = "RackensTracker has not seen any max level characters log in to the game so it has no instance lockout or currency information available for display."
